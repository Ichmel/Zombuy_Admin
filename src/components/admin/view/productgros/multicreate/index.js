...
import { GetCategoryList, GetProductGros } from '../../../../services';
...
export default class Edit extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            productId: self.id , nomprod: self.nomprod, image: '', description: self.description, prix: self.prix, prixF: self.prixF, adresseF: self.adresseF, qty: self.qty, nomF: self.nomF, contactF:  self.contactF, localF: self.localF,
        }
    }
    handleBack() {
    ...
    handleSubmit = event => {
        ...
        const { /*selectedCategory, selectedSubCategory, selectedChildCategory */  prixF,productId, nomprod, image, prix, adresseF, qty, taille, couleur, nomF, contactF, localF, description,  } = this.state;
       ...
       // formData.append('categoryId', selectedCategory);
        ...
        swal({
            ...
            .then(async (success) => {
                if (success) {
                    let list = await GetProductGros.addMultiProductList(formData, config);
                    if (list) {
                                    ...
                                    <div className="col-lg-2 col-md-2">
                                        ...
                                        <div className="col-lg-2 col-md-2">
                                            <div className="form-group">
                                                ...
                                                <input type="text" className="form-control" placeholder="adresse fourniseur" name="adresseF" value={this.state.adresseF} onChange={(e) => this.handleChange(e)} />
                                            </div>
                                        </div>
