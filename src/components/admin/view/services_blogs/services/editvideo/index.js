...
export default class Editvideo extends Component {
    constructor(props) {
        ...
        this.state = {
           id: self.id, titrevideo: self.titrevideo, textvideo: self.textvideo, video: ''
        }
    }
    handleChange(e) {
    ...
    handleSubmit = event => {
        ...
        const { id, titrevideo, textvideo, video } = this.state
        ...
        swal({
            ...
            .then(async (success) => {
                if (success) {
                    let list = await GetProductDetails.getUpdateservicevideo(formData, config);
                    if (list) {
                        this.setState({ loading: false })
                        this.props.history.push("/admin/serblog/service")
                    } else {
                                    ...
                                    <div className="col-lg-3 col-md-2">
                                        ...
                                        <div className="col-lg-4 col-md-2">
                                            <div className="form-group">
                                                ...
                                                <input type="text" className="form-control" placeholder="titre" name="titrevideo" value={this.state.titrevideo} onChange={(e) => this.handleChange(e)} />
                                            </div>
                                        </div>
                                        ...
                                        <div className="col-lg-5 col-md-2">
                                            <div className="form-group">
                                                ...
                                                <textarea  rows='4' cols='50' type="text" className="form-control" placeholder="description" name="textvideo" value={this.state.textvideo} onChange={(e) => this.handleChange(e)} />
                                            </div>
                                        </div>
