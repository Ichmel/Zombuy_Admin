...
export default class Edit extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            productId: self.id , nomprod: self.nomprod, image: '', description: self.description, prix: self.prix,prixF: self.prixF,adresseF: self.adresseF, ancienprix: self.ancienprix, qty: self.qty, nomF: self.nomF, contactF:  self.contactF, localF: self.localF, engros: value
        }
    }
    handleBack() {
    ...
    handleSubmit = event => {
       ...
       // formData.append('categoryId', selectedCategory);
        ...
        swal({
            ...
            .then(async (success) => {
                if (success) {
                    let list = await GetProductDetails.addMultiProductList(formData, config);
                    if (list) {
        ...
        return (
            <div className="container-fluid">
                ...
                <ol className="breadcrumb mb-30">
                    ...
                    <li className="breadcrumb-item active">Ajouter  MultiProduit</li>
                </ol>
                            ...
                            <div className="card-body-table m-3">
                                <div className="news-content-right pd-20">
                                    ...
                                    <div className="button_price d-sm-flex align-items-center">
                                        ...
                                        <div className="form-group">
                                            <button className="save-btn hover-btn" type="submit" onClick={this.handleSubmit}>Adjouter Produit</button>
                                        </div>
                                    </div>
