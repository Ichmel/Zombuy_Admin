...
export default class Edit extends Component {
    constructor(props) {
        super(props);
        const { name, description } = this.props.state;
        this.state = {
    ...
    async handleSubmit(e) {
        let data = { id: this.props.state.id, name: this.state.name, description: this.state.description}
        let list = await GetCategoryList.getUpdateSubCategoryList(data);
        if(list){
